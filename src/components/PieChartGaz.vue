<script setup>
    ...
    onMounted(async() => {
        await fetch('https://opendata.agenceore.fr/api/records/1.0/search/?dataset=conso-elec-gaz-annuelle-par-secteur-dactivite-agregee-region&q=&rows=150&refine.operateur=GRDF&refine.filiere=Gaz')
